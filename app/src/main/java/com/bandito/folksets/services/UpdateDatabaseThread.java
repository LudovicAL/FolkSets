...
public class UpdateDatabaseThread extends Thread {
    ...
    public void run() {
        try {
            ...
            //Get unique values
            StaticData.uniqueTuneTitleArray = DatabaseManager.getAllUniqueValueInTuneTable(TUNE_TITLES);
            ...
            StaticData.uniqueTuneComposerArray = DatabaseManager.getAllUniqueValueInTuneTable(TUNE_COMPOSERS);
            ...
            StaticData.uniqueTuneRegionArray = DatabaseManager.getAllUniqueValueInTuneTable(TUNE_REGION_OF_ORIGIN);
            ...
            StaticData.uniqueTuneKeyArray = DatabaseManager.getAllUniqueValueInTuneTable(TUNE_KEY);
            ...
            StaticData.uniqueTuneIncipitArray = DatabaseManager.getAllUniqueValueInTuneTable(TUNE_INCIPIT);
            ...
            StaticData.uniqueTuneFormArray = DatabaseManager.getAllUniqueValueInTuneTable(TUNE_FORM);
            ...
            StaticData.uniqueTuneNoteArray = DatabaseManager.getAllUniqueValueInTuneTable(TUNE_NOTE);
